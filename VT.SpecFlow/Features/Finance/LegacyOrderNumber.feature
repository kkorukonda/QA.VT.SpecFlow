Feature: LegacyOrderNumber

<RT202> <Legacy Order Number>

@Finance @IFS
Scenario: Verify LegacyOrderNumber in TableView
Given User Visits IFS
	...
	And I wait '15' seconds
	Then I verify 'Legacy Order Number' is displayed
	...
	@Finance @IFS
	Scenario: Verify LegacyOrderNumber in ListView
	Given User Visits IFS
	And I wait '5' seconds
 	When I click the 'AurenaLink' image
	And I log into IFS
